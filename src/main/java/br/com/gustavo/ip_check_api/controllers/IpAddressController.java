...
public class IpAddressController {
    ...
    @Operation(summary = "Import IP addresses from CSV file", description = "Imports IP addresses from an uploaded CSV file. The first column must contain the IP address.")
